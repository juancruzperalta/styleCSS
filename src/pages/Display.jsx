        ...
        >
          <div className="flex flex-col w-full mt-4">
            ...
            <article className="bg-[#dadada81] p-4 rounded-md mt-6 mb-4">
              ...
              <div className="grid grid-cols-2 lg:flex-row lg:justify-center lg:items-center gap-4 mt-2">
                <pre className="bg-[#1b1b1b]  text-white p-4 rounded-lg shadow-lg">
                  <code>
                ...
                <div className="bg-blue-300 text-black rounded-md w-full h-full p-2 elementNone">
                  This is a div that contains a class to press the button to
                  hide the element.
                </div>
              </div>
              <button
                className="bg-yellow-300 p-2 rounded-md border-none mt-2 text-black"
                onClick={addDisplayNone}
              >
                Click
              </button>
              <h2 className="text-yellow-300 font-bold text-xl mt-4">
                Display Block
              </h2>
              <h4 className="text-gray-200">
              ...
              <div className="grid grid-cols-2 lg:flex-row lg:justify-center lg:items-center gap-4 mt-2">
                ...
                <div className="bg-blue-300 text-black rounded-md w-full h-full p-2 block">
